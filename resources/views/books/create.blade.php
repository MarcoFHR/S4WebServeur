                    ...
                    <form method="POST" action="{{ route('books.store') }}">
                      @csrf
                        ...
                        <div class='mt-4'>
                            ...
                            <x-text-input id="is_published" class="block mt-1 w-full" type="text" name="is_published" :value="old('is_published')"
                        ...
                        <div class='mt-4'>
                            ...
                            <x-text-input id="author_id" class="block mt-1 w-full" type="text" name="author_id" :value="old('author_id')"
